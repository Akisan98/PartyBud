...
namespace Party_Bud
{
    class NeverHaveIQuestionSet
    {
        ...
        string[] questions = new string[] {
            ...
            "chattet med en bare fordi jeg kjedet meg.",
            "vært i håndjern",
            ...
            "stalket en eks-kjærestes nye kjæreste på sosiale medier",
            "spist fisk",
            "vært på en blind date.",
            "sett på barne-TV selv om jeg er voksen.",
            "spist på en restaurant hvoretter jeg har gått fra regningen",
            ...
            "prøvd å ta viagra",
            "gått inn i noe eller falt fordi jeg har gått med nesen i telefonen",
            "vært utro mot deg.",
            ...
            "stalket en annen person på Facebook",
            "klappet en hest",
            "vært forelsket i noen som var +5 år eldre enn meg",
            "sunget og tatt opptak for å høre min egen sangstemme",
            ...
            "gått skinny dipping.",
            "barbert hodet mitt.",
            "kysset min beste venn.",
            "ghosted noen.",
            "slid into noens DM.",
            "brutt et bein.",
            "dined and dashed.",
            "brukte falsk ID.",
            "spilt flaske tuten peker på.",
            "spist kremfløte rett ut av boksen.",
            "snek seg inn på en kinovisning",
            "kysset en venns eks.",
            "blitt kalt en player.",
            "vært på audition for et reality -tv -show.",
            "sagt at jeg skulle til en venn, men egentlig var et annet sted.",
            "overnattet på sykehuset.",
            "havnet i en bilulykke.",
            "hatt en negativ bankkontosaldo",
            "snakket med et familiemedlem om sexlivet mitt.",
            "spist kaviar.",
            "blitt sparket.",
            "farget håret mitt.",
            "kastet opp etter en berg- og dalbane.",
            "så en hel tv -serie på en dag.",
        };
    }
}
